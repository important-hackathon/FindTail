...
export default function LoginPageContent({ fontClass }: LoginPageContentProps) {
  const searchParams = useSearchParams();
  const isRegistered = searchParams.get("registered") === "true";

  return (
    <div
      className={`${fontClass} min-h-screen bg-[#F7EFE3] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden`}
    >
      <Image
